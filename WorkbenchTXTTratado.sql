...
CREATE UNIQUE INDEX id_Func_UNIQUE ON Funcionário (id_Func ASC) VISIBLE;

CREATE UNIQUE INDEX CPF_UNIQUE ON Funcionário (CPF ASC) VISIBLE;

CREATE UNIQUE INDEX RG_UNIQUE ON Funcionário (RG ASC) VISIBLE;
...
CREATE INDEX fk_Experiência_Línguas_Funcionário_idx ON Experiência_Línguas (Funcionário_id_Func ASC) VISIBLE;
...
CREATE UNIQUE INDEX passaporte_UNIQUE ON Tripulação (passaporte ASC) VISIBLE;
...
CREATE INDEX fk_Especialidade_Voo_Tripulação1_idx ON Especialidade_Voo (Tripulação_Funcionário_id_Func ASC) VISIBLE;
...
CREATE UNIQUE INDEX cep_UNIQUE ON Cep_Localidades (cep ASC) VISIBLE;
...
CREATE UNIQUE INDEX cod_IATA_UNIQUE ON Aeroporto (cod_IATA ASC) VISIBLE;

CREATE UNIQUE INDEX nome_UNIQUE ON Aeroporto (nome ASC) VISIBLE;

CREATE UNIQUE INDEX logradouro_UNIQUE ON Aeroporto (logradouro ASC) VISIBLE;

CREATE INDEX fk_Aeroporto_Cep_Localidades1_idx ON Aeroporto (Cep_Localidades_cep ASC) VISIBLE;

CREATE UNIQUE INDEX Cep_Localidades_cep_UNIQUE ON Aeroporto (Cep_Localidades_cep ASC) VISIBLE;
...
CREATE UNIQUE INDEX cod_pres_UNIQUE ON Presencial (cod_pres ASC) VISIBLE;

CREATE INDEX fk_Presencial_Aeroporto1_idx ON Presencial (Aeroporto_cod_IATA ASC) VISIBLE;
...
CREATE UNIQUE INDEX cod_aeronave_UNIQUE ON Aeronave (cod_aeronave ASC) VISIBLE;

CREATE INDEX fk_Aeronave_Aeroporto1_idx ON Aeronave (Aeroporto_cod_IATA ASC) VISIBLE;
...
CREATE UNIQUE INDEX cod_voo_UNIQUE ON Voo (cod_voo ASC) VISIBLE;

CREATE INDEX fk_Voo_Aeroporto1_idx ON Voo (Aeroporto_cod_Chegada ASC) VISIBLE;

CREATE INDEX fk_Voo_Aeronave1_idx ON Voo (Aeronave_cod_aeronave ASC) VISIBLE;

CREATE INDEX fk_Voo_Aeroporto2_idx ON Voo (Aeroporto_cod_Saída ASC) VISIBLE;
...
CREATE INDEX fk_Voo_has_Tripulação_Tripulação1_idx ON Tripulação_Voo (Tripulação_Funcionário_id_Func ASC) VISIBLE;

CREATE INDEX fk_Voo_has_Tripulação_Voo1_idx ON Tripulação_Voo (Voo_cod_voo ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS Passageiro (
  ...
  tipo VARCHAR(45) NOT NULL,
  milhas_totais INTEGER ZEROFILL NULL,
  nro_notas_fiscais INTEGER UNSIGNED NOT NULL,
  prim_nome VARCHAR(50) NOT NULL,
  sobrenome VARCHAR(100) NOT NULL,
  sexo VARCHAR(4) NOT NULL,
  data_nasc DATE NOT NULL,
...
CREATE UNIQUE INDEX ID_pas_UNIQUE ON Passageiro (ID_pas ASC) VISIBLE;

CREATE UNIQUE INDEX RG_copy1_UNIQUE ON Passageiro (RG ASC) VISIBLE;

CREATE UNIQUE INDEX CPF_UNIQUE ON Passageiro (CPF ASC) VISIBLE;

CREATE INDEX fk_Passageiro_Presencial1_idx ON Passageiro (Presencial_Funcionário_id_Func ASC) VISIBLE;
...
CREATE UNIQUE INDEX cod_viagem_UNIQUE ON Viagem (cod_viagem ASC) VISIBLE;

CREATE INDEX fk_Viagem_Trecho1_idx ON Viagem (Trecho_cod_trecho ASC) VISIBLE;

CREATE INDEX fk_Viagem_Passageiro1_idx ON Viagem (Passageiro_ID_pas ASC) VISIBLE;
...
CREATE UNIQUE INDEX cod_bagagem_UNIQUE ON Bagagem (cod_bagagem ASC) VISIBLE;

CREATE INDEX fk_Bagagem_Presencial1_idx ON Bagagem (Presencial_Funcionário_id_Func ASC) VISIBLE;

CREATE INDEX fk_Bagagem_Viagem1_idx ON Bagagem (Viagem_cod_viagem ASC) VISIBLE;
...
CREATE UNIQUE INDEX Telefone_UNIQUE ON Responsáveis (Telefone ASC) VISIBLE;
...
CREATE INDEX fk_Trecho_has_Voo_Voo1_idx ON Trecho_Voo (Voo_cod_voo ASC) VISIBLE;

CREATE INDEX fk_Trecho_has_Voo_Trecho1_idx ON Trecho_Voo (Trecho_cod_trecho ASC) VISIBLE;
